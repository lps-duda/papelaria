...
<head>
    ...
    <title>Login — Ordem & Papel</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        *{box-sizing:border-box;margin:0;padding:0;font-family:'Segoe UI',sans-serif}
        body{background:#f5f0f0;display:flex;align-items:center;justify-content:center;min-height:100vh}
        ...
        .forgot a{font-size:12px;color:#C0392B;text-decoration:none;font-weight:600}
...
<div class="card">
    ...
    <div class="card-body">
        <div class="tag">Acesso ao sistema</div>
        <div class="card-title">Ordem & Papel</div>
        <div class="card-subtitle">Entre com sua conta para continuar</div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <button type="submit" class="btn-submit">Entrar na Papelaria</button>
        </form>

        <div class="card-footer">Não tem conta? <a href="{{ route('register') }}">Cadastre-se</a></div>
